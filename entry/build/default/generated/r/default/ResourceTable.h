...
const int32_t STRING_DISTRIBUTED_DATA_REASON = 0x0100000a;
const int32_t STRING_MODULE_DESC = 0x01000004;
const int32_t COLOR_PAGE_BACKGROUND = 0x01000005;
const int32_t COLOR_START_WINDOW_BACKGROUND = 0x01000006;
const int32_t FLOAT_PAGE_BODY_FONT_SIZE = 0x01000007;
const int32_t FLOAT_PAGE_TITLE_FONT_SIZE = 0x01000008;
